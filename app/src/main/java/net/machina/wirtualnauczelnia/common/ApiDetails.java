...
//  Adresy endpointów
    ...
    public static final String API_ADDRESS_SCHEDULE = API_ADDRESS_BASE + "PodzGodzin.aspx";
...
//  Pola formularzy
    ...
    public static final String API_FIELD_SCHEDULE_BUTTON_NEXT = "ctl00$ctl00$ContentPlaceHolder$RightContentPlaceHolder$butN";
    public static final String API_FIELD_SCHEDULE_BUTTON_PREV = "ctl00$ctl00$ContentPlaceHolder$RightContentPlaceHolder$butP";
    public static final String API_FIELD_SCHEDULE_RANGE = "ctl00$ctl00$ContentPlaceHolder$RightContentPlaceHolder$rbJak";
...
//  Domyślne wartości
    ...
    public static final String API_DEF_VALUE_BUTTON_PREV = "Poprzedni";
    public static final String API_DEF_VALUE_BUTTON_NEXT = "Następny";
    public static final String API_DEF_VALUE_SCHEDULE_WEEKLY = "Tygodniowo";
